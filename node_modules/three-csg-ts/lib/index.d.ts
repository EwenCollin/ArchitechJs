import { BufferGeometry, Geometry, Matrix4, Mesh, Vector2, Vector3 } from 'three';
/**
...
export declare class CSG {
    ...
    static toMesh(csg: CSG, toMatrix: Matrix4): Mesh<Geometry, import("three").Material | import("three").Material[]>;
    static iEval(tokens: Mesh): void;
    static eval(tokens: Mesh, doRemove: boolean): Mesh<Geometry, import("three").Material | import("three").Material[]>;
